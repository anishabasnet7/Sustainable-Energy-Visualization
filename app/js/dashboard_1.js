export function draw_overall_co2_timeseries(data_path, containerId = '#d3-chart') {
    ...
    d3.csv(data_path).then(raw_data => {
        ...
        g.selectAll("dot")
            ...
            .on("mouseover", function(event, d) {
                ...
                tooltip.html(`
                    ...
                    <strong>Emissions:</strong> ${d3.format(".3s")(d.total_emission)}
                `);
            })
        ...
        console.error("Failed to load or process CSV file:", error);
        g.append("text")
            .attr("x", innerWidth / 2)
            .attr("y", innerHeight / 2)
            .attr("text-anchor", "middle")
            .attr("fill", "red")
            .text("Error: Could not load data from path: " + data_path);
    });
}
